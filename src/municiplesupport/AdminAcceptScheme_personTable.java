 ...
 * @author kishore
 */
public class AdminAcceptScheme_personTable extends AbstractTableModel {
    ...
    public AdminAcceptScheme_personTable(String ward,String house) {
       users = acr.getAdminAcceptScheme(ward,house);
            ...
            btn.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent ae) {
                    ...
                    if (result == JOptionPane.OK_OPTION) {
                      ...
                      AdminAcceptScheme_personTable.this.fireTableDataChanged();
                    } 
                }
            });
            return btn;
