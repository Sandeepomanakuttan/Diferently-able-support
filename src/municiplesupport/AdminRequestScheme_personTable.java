 ...
 * @author kishore
 */
public class AdminRequestScheme_personTable extends AbstractTableModel {
    ...
    public AdminRequestScheme_personTable(String ward,String house) {
       users = acr.getAdminRequestScheme(ward,house);
            ...
            btn1.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent ae) {
                    ...
                    if (result == JOptionPane.OK_OPTION) {
                        ...
                        AdminRequestScheme_personTable.this.fireTableDataChanged();
                    } 
                }
            });
            return btn1;
