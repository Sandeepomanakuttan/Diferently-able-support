 ...
 * @author kishore
 */
public class AdminRejectScheme_personTable extends AbstractTableModel {
    ...
    public AdminRejectScheme_personTable(String ward ,String house) {
       users = acr.getAdminRejectScheme(ward,house);
            ...
            btn.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent ae) {
                    ...
                    if (result == JOptionPane.OK_OPTION) {
                        ...
                        AdminRejectScheme_personTable.this.fireTableDataChanged();
                    } 
                }
            });
            return btn;
